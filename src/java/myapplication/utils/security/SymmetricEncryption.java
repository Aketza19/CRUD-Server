...
public class SymmetricEncryption {
    ...
    private static String salt = "!JDEIF%FERFT&$d346";
    private static ResourceBundle rb = ResourceBundle.getBundle("config.config");
    private static String secretKey = "";

    public SymmetricEncryption() {
        this.secretKey = rb.getString("SYMMETRIC_ENCRYPTION_KEY");
    }

    /**
     * Encrypts a string using the secret key stored in the properties file.
    ...
    /**
     * Decrypts a text using the secret.
